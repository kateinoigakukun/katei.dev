...
Thanks to [Jonas Devlieghere](https://github.com/JDevlieghere) for the debugger work, [Max Desiatov](https://github.com/MaxDesiatov) for Relaxed SIMD, extended-const, the WIT extractor rewrite and the command line improvements, and to [Joannis Orlandos](https://github.com/Joannis), [Kenta Kubo](https://github.com/kkk669) and [shopifyski](https://github.com/shopifyski) for their contributions to this release.
